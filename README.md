...
The goal of UX is to increase usability, not just in mobile applications, but in all things. This has been around even before there are mobile applications. The inability to use simple things like just opening a door is not 'Human Error', but the real culprit is faulty design. Designs who lack:
- Visibility
- Feedback
- Constraints
- Mapping
